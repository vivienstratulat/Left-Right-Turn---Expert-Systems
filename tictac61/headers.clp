...
; SCENARIUL 1:
(defglobal ?*totalNrRules* = 320)

; SCENARIUL 2:
;(defglobal ?*totalNrRules* = 130)

; SCENARIUL 3:
;(defglobal ?*totalNrRules* = 130)

; SCENARIUL 4:
;(defglobal ?*totalNrRules* = 360)

; SCENARIUL 5:
;(defglobal ?*totalNrRules* = 330)

; SCENARIUL 6:
;(defglobal ?*totalNrRules* = 220)
...
(defglobal ?*perceptsDir* = "./perceptiiTest01/")
;(defglobal ?*perceptsDir* = "./perceptiiTest02/")
;(defglobal ?*perceptsDir* = "./perceptiiTest03/")
;(defglobal ?*perceptsDir* = "./perceptiiTest04/")
;(defglobal ?*perceptsDir* = "./perceptiiTest05/")
;(defglobal ?*perceptsDir* = "./perceptiiTest06/")


(defglobal ?*car-address* = "Str. Lucian Blaga")
